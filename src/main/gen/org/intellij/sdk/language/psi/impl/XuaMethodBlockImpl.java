...
public class XuaMethodBlockImpl extends ASTWrapperPsiElement implements XuaMethodBlock {
  ...
  @Override
  @NotNull
  public List<XuaParametersBlock> getParametersBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, XuaParametersBlock.class);
  }

  @Override
  @Nullable
  public XuaPhpBlock getPhpBlock() {
    return findChildByClass(XuaPhpBlock.class);
  }
