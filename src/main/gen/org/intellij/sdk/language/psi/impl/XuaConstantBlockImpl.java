...
public class XuaConstantBlockImpl extends ASTWrapperPsiElement implements XuaConstantBlock {

  public XuaConstantBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XuaVisitor visitor) {
    visitor.visitConstantBlock(this);
  }
